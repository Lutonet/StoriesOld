...
namespace Stories.Areas.Identity.Pages.Account.Manage
{
    public static class ManageNavPages
    {
        ...
        public static string ProfilePrivacy => "ProfilePrivacy";
        ...
        public static string ProfilePrivacyNavClass(ViewContext viewContext) => PageNavClass(viewContext, ProfilePrivacy);
