...
namespace Stories.Pages.Messages
{
    public class InboxModel : PageModel
    {
        ...
        private ILogger<InboxModel> _logger;
        ...
        public InboxModel(ApplicationDbContext dbContext, ILogger<InboxModel> logger, UserManager<User> userManager, SignInManager<User> signInManager)
        {
