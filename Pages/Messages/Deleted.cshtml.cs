...
namespace Stories.Pages.Messages
{
    public class DeletedModel : PageModel
    {
        ...
        private ILogger<DeletedModel> _logger;
        ...
        public DeletedModel(ApplicationDbContext dbContext, ILogger<DeletedModel> logger, UserManager<User> userManager, SignInManager<User> signInManager)
        {
