...
namespace Stories.Pages.Messages
{
    public class SentModel : PageModel
    {
        ...
        private ILogger<SentModel> _logger;
        ...
        public SentModel(ApplicationDbContext dbContext, ILogger<SentModel> logger, UserManager<User> userManager, SignInManager<User> signInManager)
        {
